...
# Phase J live test removed 2026-05-23: the SUBSONIC_FUEL_FLOW_SCALER
# injection landed in aviary's applied list but had no measurable
# effect on fuel_burned_kg (sensitivity sweep in
# tests/test_phase_hj_coupling_validation.py showed identical
# 7058.4 kg for SFC ∈ {0.40, 0.55, 0.70}). The FwFm bench engine
# deck is tabular and doesn't honor the analytic scaler. Phase J
# middleware reverted; this test would have been a false-positive
# (it only checked "value made it to aviary", not "value affected
# the trajectory").
